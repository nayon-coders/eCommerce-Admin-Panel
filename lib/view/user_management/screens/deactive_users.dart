...
class DeactivateUsers extends StatefulWidget {
  DeactivateUsers({super.key});

  @override
  State<DeactivateUsers> createState() => _DeactivateUsersState();
}

class _DeactivateUsersState extends State<DeactivateUsers> {
              ...
              builder: (context, snapshot) {
                ...
                ListView.builder(
                  ...
                  itemBuilder: (_, index){
                    ...
                    return  data.status == "Deactivate" ? Container(
                      width: double.infinity,
                      height: 50,
                      padding: EdgeInsets.only(left: 20, right: 20),
                      decoration: BoxDecoration(
